...
public class VehicleTest {
    ...
    public void testVehicleAttributes() {
        Vehicle vehicle = new Vehicle("DMS-Z99", "Toyota Camry");
    ...
    public void testEquals() {
        Vehicle vehicle1 = new Vehicle("DMS-Z99", "Toyota Camry");
        Vehicle vehicle2 = new Vehicle("DMS-Z99", "Toyota Camry");
        Vehicle vehicle3 = new Vehicle("DDO-L33", "Honda Civic");
